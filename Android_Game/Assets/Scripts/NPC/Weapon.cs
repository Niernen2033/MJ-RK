...
public class Weapon : Item
{
    ...
    public Weapon(ItemType itemType, string name, double durability, int goldValue, double weight, bool isUsed, bool isBroken,
        Statistics basicDamage, Statistics vitalityBonus, Statistics dexterityBonus, Statistics intelligenceBonus,
        Statistics strengthBonus) : base(ItemClass.Weapon, itemType, name, durability, goldValue, weight, isUsed, isBroken)
    {
